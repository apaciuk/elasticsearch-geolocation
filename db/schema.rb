...
ActiveRecord::Schema[7.0].define(version: 2023_01_29_145240) do
  ...
  create_table "categories_venues", id: false, force: :cascade do |t|
    ...
    t.index ["category_id", "venue_id"], name: "index_categories_venues_on_category_id_and_venue_id"
    t.index ["venue_id", "category_id"], name: "index_categories_venues_on_venue_id_and_category_id"
  end
